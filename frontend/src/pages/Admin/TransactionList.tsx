...
export default function TransactionList() {
    ...
    useEffect(() => {
        ...
        const fetchTransactionList = async () => {
            try {
                const response = await axiosInstance.get("/admin/transaction-list");
                    ...
                    <TableBody>
                        {transactionList.map((transaction) => (
                            <TableRow key={transaction._id}>
                                ...
                                <TableCell>
                                    <Badge variant={transaction.status === "failed" ? "destructive" : transaction.status === "success" ? "success" : "default"}>
                                        {transaction.status}
                                    </Badge>
                                </TableCell>
